...
python3 "${SCRIPT_DIR}/evaluate_lizard_to_old4.py" \
  --gt-dir "/mnt/j/HandE/new_training_set/T_S_40_Json_All_40/json" \
  --pred-dir "/mnt/j/HandE/new_training_set/cellvitpp_lizard_3in1/cellvitpp_lizard_t_s_40" \
  --gt-glob "*.json" \
  --pred-glob "*_cells.json" \
  --iou-threshold 0.2 \
  --output-dir "${SCRIPT_DIR}/eval_results_t_s_40"