...
Inputs (directories):
  ...
  --artifact-h5-dir  : Artifact ilastik HDF5 probability maps (*_Probabilities.h5)
  --rbc-h5-dir       : optional RBC ilastik HDF5 probability maps (same stems)
...
def main() -> None:
    ...
    artifact_h5_map = build_h5_map(args.artifact_h5_dir)
